...
def process_data():
    ...
    # Define constants
    gdrive_download_url = "https://drive.google.com/file/d/14WFEUKvaEDatAf13w8-PtkPuKC7j_uOa/view?usp=sharing"
    ...
    def split_dataset(base_dir, output_dir, test_size=0.3):
        ...
        :param base_dir: Path to the dataset directory containing 'images' and 'annotations'.
        :param output_dir: Path to the output directory for split data.
        :param test_size: Fraction of the data to be used for testing (default is 0.3 for 70/30 split).
        """
        # Define paths
